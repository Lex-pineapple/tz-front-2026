...
export const RequestTableRow = ({ request, onDelete, onRowClick }: RequestTableRowProps) => {
  return (
    <Table.Row key={request.id} _hover={{ bg: 'gray.50', cursor: 'pointer' }} onClick={() => onRowClick?.(request)}>
